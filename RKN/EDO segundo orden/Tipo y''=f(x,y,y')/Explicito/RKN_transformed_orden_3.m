...
for i = 1:n-1
    ...
    K2 = f(x(i,1) + (1/2)*h,y(i,1) + (1/2)*h*yprima(i,1),yprima(i,1) + (1/2)*h*K1);
    K3 = f(x(i,1) + (3/4)*h,y(i,1) + (3/4)*h*yprima(i,1) + (3/8)*h^2*K1,yprima(i,1) + (3/4)*h*K2);
    y(i+1,1) = y(i,1) + h*yprima(i,1) + h^2*((1/6)*K1 + (1/3)*K2);
