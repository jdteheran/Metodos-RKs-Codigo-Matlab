...
%EJEMPLO: [x,y] = RK4(0.01,1/2,100,0.0099999166667361106977490148082,0.000110517092175955069979947);
...
for i = 1:n-1
    ...
    KX4 = f(t(i,1) + h,x(i,1) + h*KX2,y(i,1) + h*KY2);
    KY4 = g(t(i,1) + h,x(i,1) + h*KX2,y(i,1) + h*KY2);
